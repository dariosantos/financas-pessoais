...
<div role="main">
    ...
    <table id="table_edit_inline" data-type="categories">
        <thead>
            <tr>
                <th>Name</th>
                <th>Edit</th>
        ...
        <tbody>
            ...
            if (is_resource($resource)) {
                ...
                while ($row = mysql_fetch_array($resource)) {
                    echo '<tr>';
                    echo '<td><div id="id_' . $row['id_category'] . '" class="editable">' . $row['name'] . '</div></td>';
                    echo '<td><a href="#id_' . $row['id_category'] . '" class="link_edit">Edit</a></td>';
//                    echo '<td><a href="#id_' . $row['id_category'] . '" class="link_remove">Remove</a></td>';
                    echo '</tr>';
                }
                if ($found_selected <= 0) {
